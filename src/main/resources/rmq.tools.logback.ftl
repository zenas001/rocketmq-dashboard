...
<configuration scan="true" scanPeriod="30 seconds">
    <appender name="DefaultAppender"
        ...
        <file>${logRootDir}${fileSeparator}logs${fileSeparator}rocketmqlogs${fileSeparator}tools_default.log</file>
        <append>true</append>
        <rollingPolicy class="ch.qos.logback.core.rolling.FixedWindowRollingPolicy">
            <fileNamePattern>${logRootDir}${fileSeparator}logs${fileSeparator}rocketmqlogs${fileSeparator}otherdays${fileSeparator}tools_default.%i.log.gz</fileNamePattern>
            <minIndex>1</minIndex>
            <maxIndex>5</maxIndex>
        </rollingPolicy>
    ...
    <appender name="RocketmqToolsAppender_inner"
              class="ch.qos.logback.core.rolling.RollingFileAppender">
        <file>${logRootDir}${fileSeparator}logs${fileSeparator}rocketmqlogs${fileSeparator}tools.log</file>
        <append>true</append>
        <rollingPolicy class="ch.qos.logback.core.rolling.FixedWindowRollingPolicy">
            <fileNamePattern>${logRootDir}${fileSeparator}logs${fileSeparator}rocketmqlogs${fileSeparator}otherdays${fileSeparator}tools.%i.log.gz</fileNamePattern>
            <minIndex>1</minIndex>
            <maxIndex>5</maxIndex>
        </rollingPolicy>
        <triggeringPolicy
